...
?>
    <tr class="dong">
        ...
        <td>
            <a href="index.php?page=nhacungcap-edit&id=<?php echo $row['id_ncc']; ?>" class="btn btn-primary btn-xs">Edit</a>
            <a href="#" class="btn btn-danger btn-xs" data-href="index.php?page=nhacungcap-delete&id=<?php echo $row['id_ncc']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>
        </td>
    </tr>
