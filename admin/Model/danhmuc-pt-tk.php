...
?>
    <tr class="dong">
        ...
        <td>
            ...
            <a href="#" class="btn btn-danger btn-xs" data-href="index.php?page=danhmuc-delete&id=<?php echo $row['id_dm']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>
        </td>
    </tr>
