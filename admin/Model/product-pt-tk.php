...
?>
    <tr class="dong">
        ...
        <td>
            <a href="index.php?page=product-edit&id=<?php echo $row['id_pro']; ?>" class="btn btn-primary btn-xs">Edit</a>
            <a href="#" class="btn btn-danger btn-xs" data-href="index.php?page=product-delete&id=<?php echo $row['id_pro']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>
        </td>
